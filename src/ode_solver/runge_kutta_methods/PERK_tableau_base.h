#ifndef __PERK_TABLEAU_BASE__
#define __PERK_TABLEAU_BASE__
...
#endif
class PERKTableauBase
{
public:
    /// Default constructor that will set the constants.
    PERKTableauBase(const int n_rk_stages, const std::string rk_method_string_input); 
